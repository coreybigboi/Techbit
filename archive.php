...
<html>
  ...
  <body>
	...
	// configures the vote buttons depending on what the user has voted if at all
	function voteButtons($row){	
		...
		if(mysqli_num_rows($ratingResult) > 0){
     		...
     		echo "<form id=\"vote\" method=\"POST\" action=\"archive.php\">";   
	...
	// displays all posts except the 4 most recent
	function postAll(){
    		global $conn;
  	...
  	require "menu.php";
	echo "<br />";
	echo "<h1 class=\"pageTitle\">Archive</h1>";
	postAll();
    ?>
